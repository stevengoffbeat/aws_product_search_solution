...
def data_load(invoke_url,index,file_name,load_type,text_coloum_name: str='',image_coloum_name: str='',text_endpoint_name: str='',image_endpoint_name: str=''):
    url = invoke_url + '/data_load?'
    url += ('&index='+index)
    url += ('&task=data_load')
            ...
            with st.empty():
                for i in range(len(file_list)):
                    ...
                    if len(split_data) > 0:
                        ...
                        response = data_load(invoke_url,index,object_name,load_type,text_coloum_name,image_coloum_name,text_endpoint_name,image_endpoint_name)
